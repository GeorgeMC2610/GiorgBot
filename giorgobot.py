...
help_dialog7 = '**ΕΝΤΟΛΕΣ ΔΙΑΧΕΙΡΙΣΤΗ:**'
help_dialog8 = '`!display members` --> Προβολή όλων των μελών του σέρβερ.' 
help_dialog9 = '`!prune <αριθμός 1-50>` --> Σβήσιμο όλων των προηγούμενων μηνυμάτων"'
